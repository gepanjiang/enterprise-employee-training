	...
	<table width='99%' height="100%" border='0' cellspacing='0' cellpadding='0'>
	  <tr>
		...
		<!-- 1 -->
	      ...
	      <!-- 1 -->
	      <dl class='bitem'>
	        <dt onClick='showHide("items2_1")'><b>员工信息管理</b></dt>
	        <dd style='display:block' class='sitem' id='items2_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/orgMana.action' target='main'>部门信息管理</a></li>
	            <li><a href='<%=path %>/yuangongMana.action' target='main'>员工信息管理</a></li>
	            <li><a href='<%=path %>/admin/yuangong/yuangongAdd.jsp' target='main'>员工信息添加</a></li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
	      <!-- 1 -->
	      <dl class='bitem'>
	        <dt onClick='showHide("items2_1")'><b>培训课程管理</b></dt>
	        <dd style='display:block' class='sitem' id='items2_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/kechengMana.action' target='main'>培训课程管理</a></li>
	            <li><a href='<%=path %>/admin/kecheng/kechengAdd.jsp' target='main'>培训课程添加</a></li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
	      <!-- 1 -->
	      <dl class='bitem'>
	        <dt onClick='showHide("items2_1")'><b>培训计划管理</b></dt>
	        <dd style='display:block' class='sitem' id='items2_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/peixunMana.action' target='main'>培训计划管理</a></li>
	            <li><a href='<%=path %>/admin/peixun/peixunAdd.jsp' target='main'>培训计划制定</a></li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
	      ...
	      <!-- 1 -->
	      <dl class='bitem'>
	        <dt onClick='showHide("items2_1")'><b>培训成绩管理</b></dt>
	        <dd style='display:block' class='sitem' id='items2_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/peixunAll.action' target='main'>培训成绩管理</a></li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
